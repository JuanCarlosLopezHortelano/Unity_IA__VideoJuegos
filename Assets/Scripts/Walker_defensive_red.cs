...
public class Walker_defensive_red : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        target = GameObject.FindGameObjectWithTag("walker_leader_red");
        if(target == null)
        {
            Debug.LogError("No se encontró el objetivo con el tag 'walker_leader_red'");
        }
        else
        {
